...
public class App1 {
    public static void main(String[] args) {
        ...
        ProductOption op3 = new ProductOption(3, "노란티", 1000, 10, p2);
        ProductOption op4 = new ProductOption(4, "흰티", 2000, 10, p2);
        ...
        OrderOption orOption3 = new OrderOption(3, "흰티", 5, 10000, p2, or1);
        ...
        OrderOption orOption4 = new OrderOption(4, "노란티", 7, 7000, p2, or2);
        ...
        // 2번 문제 : 상품 상세 화면 (p2)
        // Product(p2, p2Options) -> ProductDetailDTO
